...
- `docs/HOME_PC_DEPLOYMENT.md`: Windows PC self-hosted runner, Docker Compose, Nginx Basic Auth, Cloudflare Tunnel로 API를 내 PC에서 배포하는 절차를 설명한다. YouTube transcript endpoint를 cloud IP block 없이 운영하려는 경우 읽는다.
