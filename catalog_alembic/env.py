...
import codex_sdk_cli.infra.publication.catalog_database.models  # noqa: F401
...
def _database_url() -> str:
    ...
    connection_ref = (
        x_arguments.get("connection_ref")
        or config.get_main_option("connection_ref")
        or "local-public-catalog"
    )
    return PublicationConnectionFactory.from_settings(CliSettings()).sql_catalog_database_url(
        connection_ref
    )
