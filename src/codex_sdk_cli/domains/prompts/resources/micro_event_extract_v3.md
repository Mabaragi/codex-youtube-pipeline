...
event 문장은 공손체 `~습니다`나 해요체 `~해요`가 아니라 해라체/평서형 `~다` 문장으로 작성한다.
스트리머가 우는 상황, 울상, 상처받은 반응, 삐진 리액션처럼 감정적으로 튀는 장면은 일반 유저 관심 포인트로 보고 event에 적극 반영한다.
특정 키워드 목록을 단서로 나열하지 말고, 전체 cue 흐름에서 장면의 재미와 감정 리액션을 포착한다.
